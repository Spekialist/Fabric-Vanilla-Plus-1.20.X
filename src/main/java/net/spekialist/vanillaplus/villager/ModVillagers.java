package net.spekialist.vanillaplus.villager;
...
public class ModVillagers {
    ...
    public static final PointOfInterestType SOUND_POI = registerPoi("soundpoi", ModBlocks.RUBY_BLOCK);
    ...
    private static PointOfInterestType registerPoi(String name, Block block) {
        return PointOfInterestHelper.register(new Identifier(VanillaPlus.MOD_ID, name), 1, 1, block);
    }

    private  static RegistryKey<PointOfInterestType> poiKey(String name) {
        return RegistryKey.of(RegistryKeys.POINT_OF_INTEREST_TYPE, new Identifier(VanillaPlus.MOD_ID, name));
    }

    public static void registerVillagers() {
        VanillaPlus.LOGGER.info("Registering Villagers" + VanillaPlus.MOD_ID);
    }
}
